package com.y271727uy.pomegranate.lib;
...
public final class Localization {
	/** e.g. keyString("tooltip", "eaten_status.not_eaten_1") -> "spice_of_life_pomegranate_edition.tooltip.eatenStatus.not_eaten_1") */
	public static String keyString(String domain, String path) {
		return SOLCarrot.MOD_ID + "." + domain + "." + path;
	}
